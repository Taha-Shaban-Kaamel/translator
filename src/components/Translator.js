...
export default function Translator() {
    ...
    const handleTranslate = async () => {
        ...
        const url = 
        `https://microsoft-translator-text-api3.p.rapidapi.com/translate?to%5B0%5D=${outputFormat}&api-version=3.0&profanityAction=NoAction&textType=plain`;
        
        const options = {
            method: 'POST',
            headers: {
                'content-type': 'application/json',
                'X-RapidAPI-Key': '71a34e484bmsh4c87623d85265c5p128c1ajsnfbce24614341',
